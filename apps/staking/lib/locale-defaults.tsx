...
export const defaultTranslationElements = {
  ...
  br: () => <br />,
  'discord-server-link': defaultExternalLink(SUPPORT_URL, 'XPoint support'),
  'contact-support-link': defaultExternalLink(SUPPORT_URL, 'contact the XPoint support team.'),
  ...
  'incentive-program-link': defaultExternalLink(
    ...
    'XPoint Testnet Incentive Program'
  ),
  'discord-link': externalLink(SUPPORT_URL, 'text-session-green'),
