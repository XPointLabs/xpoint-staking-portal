...
export const BASE_URL =
  ...
  `https://${getEnvironmentTaggedDomain('stake')}.xpoint.network`;
...
export const SOCIALS = {
  [Social.Discord]: { name: Social.Discord, link: SUPPORT_URL },
  [Social.X]: { name: Social.X, link: XPOINT_SITE_URL },
  [Social.Session]: { name: Social.Session, link: XPOINT_SITE_URL },
  [Social.Github]: { name: Social.Github, link: XPOINT_GITHUB_URL },
} satisfies Partial<Record<Social, SocialLink>>;

export const FOOTER_SOCIALS = {
  [Social.Session]: SOCIALS[Social.Session],
  [Social.Github]: SOCIALS[Social.Github],
} satisfies Partial<Record<Social, SocialLink>>;
...
export const SESSION_NETWORK = 'XPoint Network' as const;
