import { EXTERNAL_ROUTES, FOOTER_SOCIALS, SSR_LINKS } from '@/lib/constants';
...
export function Footer() {
  ...
  const socialLinks = Object.values(FOOTER_SOCIALS);

  return (
    <FooterComp
      logo={{ src: '/images/xpoint-logo-256.png', alt: 'XPoint Network logo' }}
      menuItems={menuItems}
